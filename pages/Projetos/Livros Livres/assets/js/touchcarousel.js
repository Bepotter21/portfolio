(function (f) {
  function r(a, c) {
    ...
    this._itemsWrapper = this._dragContainer
      .wrap(f('<div class="touchcarousel-wrapper" />'))
      .parent();
    ...
    (this.hasTouch || this.settings.useWebkit3d) &&
    ...
    this._useWebkitTransition
      ? ((this._xProp = "-webkit-transform"),
        ...
        (this._xSuf = "px, 0, 0)"))
      : ((this._xProp = "left"), (this._xPref = ""), (this._xSuf = "px"));
    this.hasTouch && (this.settings.directionNavAutoHide = !1);
    this.settings.directionNav ||
      ((this._arrowRightBlocked = this.settings.loopItems
        ? (this._arrowLeftBlocked = !0)
        : (this._arrowLeftBlocked = !1)),
      (this.settings.loopItems = !0));
    var l,
      k,
      h = 0;
    ...
    e.each(function (a) {
      ...
      if (!0 === b.settings.multiRow) {
        var c = Math.max(
          1,
          Math.floor(b._dragContainer.height() / k.outerHeight(!0))
        );
      ...
      if (this.hasTouch) {
        ...
        k.find("a").bind("click.touchcarousel", function (a) {
          if (b._successfullyDragged) return a.preventDefault(), !1;
        });
    ...
    this._itemsPerMove =
      0 < this.settings.itemsPerMove ? this.settings.itemsPerMove : 1;
    if (this.settings.pagingNav) {
      if (
        ((this._pagingEnabled = this.settings.snapToItems = !0),
        (this._numPages = Math.ceil(this.numItems / this._itemsPerMove)),
        (this._currPageId = 0),
        this.settings.pagingNavControls)
      ) {
        this._pagingNavContainer = f(
          '<div class="tc-paging-container"><div class="tc-paging-centerer"><div class="tc-paging-centerer-inside"></div></div></div>'
        );
        e = this._pagingNavContainer.find(".tc-paging-centerer-inside");
        for (g = 1; g <= this._numPages; g++)
          (d = f('<a class="tc-paging-item" href="#">' + g + "</a>").data(
            "tc-id",
            g
          )),
    ...
    this._dragContainer.css({ width: h + 5 });
    this.settings.directionNav &&
      (this._itemsWrapper.after(
        "<a href='#' class='arrow-holder left'><span class='arrow-icon left'></span></a> <a href='#' class='arrow-holder right'><span class='arrow-icon right'></span></a>"
      ),
      (this.arrowLeft = this.carouselRoot.find(".arrow-holder.left")),
      (this.arrowRight = this.carouselRoot.find(".arrow-holder.right")),
      1 > this.arrowLeft.length || 1 > this.arrowRight.length
        ? (this.settings.directionNav = !1)
        : this.settings.directionNavAutoHide &&
          (this.arrowLeft.hide(),
      ...
      this.settings.directionNav &&
        (this.arrowRight.click(function (a) {
          a.preventDefault();
          ((b.settings.loopItems && !b._blockClickEvents) ||
            !b._arrowRightBlocked) &&
            b.next();
        }),
    ...
    this._resizeEvent =
      "onorientationchange" in window
        ? "orientationchange.touchcarousel"
        : "resize.touchcarousel";
    var m;
    ...
    this.settings.scrollbar
      ? ((this._scrollbarHolder = f(
          "<div class='scrollbar-holder'><div class='scrollbar" +
            ("light" === this.settings.scrollbarTheme.toLowerCase()
              ? " light"
              : " dark") +
            "'></div></div>"
        )),
        ...
        this.settings.scrollbarAutoHide
          ? ((this._scrollbarVisible = !1), this.scrollbarJQ.css("opacity", 0))
          : (this._scrollbarVisible = !0))
      : (this.settings.scrollbarAutoHide = !1);
    this.updateCarouselSize(!0);
    this._itemsWrapper.bind(this._downEvent, function (a) {
      b._onDragStart(a);
    });
    this.settings.autoplay && 0 < this.settings.autoplayDelay
      ? ((this._isHovering = !1),
        (this.autoplayTimer = ""),
        (this.wasAutoplayRunning = !0),
        this.hasTouch ||
          this.carouselRoot.hover(
            function () {
              b._isHovering = !0;
      ...
      : (this.autoplay = !1);
    this.settings.keyboardNav &&
      f(document).bind("keydown.touchcarousel", function (a) {
        b._blockClickEvents ||
  ...
  r.prototype = {
    goTo: function (a, c) {
      ...
      b &&
        (!c &&
          this.autoplay &&
          this.settings.autoplayStopAtAction &&
          this.stopAutoplay(),
        this._updatePagingNav(a),
        (this.endPos = this._getXPos()),
        (b = -b.posX),
        0 < b
          ? (b = 0)
          : b < this.carouselWidth - this._maxXPos &&
            (b = this.carouselWidth - this._maxXPos),
        this.animateTo(b, this.settings.transitionSpeed, "easeInOutSine"));
    },
    next: function (a) {
      var c = this._getXPos(),
        b = this._getItemAtPos(c).index;
      this._pagingEnabled
        ? ((c = this._currPageId + 1),
          (b =
            c > this._numPages - 1
              ? this.settings.loopItems
                ? 0
                : (this._numPages - 1) * this._itemsPerMove
              : c * this._itemsPerMove))
        : ((b += this._itemsPerMove),
          this.settings.loopItems &&
            c <= this.carouselWidth - this._maxXPos &&
            (b = 0),
          b > this.numItems - 1 && (b = this.numItems - 1));
      this.goTo(b, a);
    },
    prev: function (a) {
      var c = this._getXPos(),
    ...
    setXPos: function (a, c) {
      c
        ? (this._scrollbarStyle[this._xProp] = this._xPref + a + this._xSuf)
        : (this._dragContainerStyle[this._xProp] =
            this._xPref + a + this._xSuf);
    },
    ...
    updateCarouselSize: function (a) {
      if (!this.settings.multiRow) {
        for (var c = 0, b = 0; b < this.numItems; b++)
          (this.items[b].width = this.items[b].item.outerWidth(!0)),
            (this.items[b].posX = c),
      ...
      if (this.settings.scrollToLast) {
        ...
        if (this._pagingEnabled)
          if (((b = this.numItems % this._itemsPerMove), 0 < b))
            for (b = this.numItems - b; b < this.numItems; b++)
              c += this.items[b].width;
      ...
      this.settings.scrollbar &&
        ((b = Math.round(
          this._scrollbarHolder.width() / (this._maxXPos / this.carouselWidth)
        )),
        this.scrollbarJQ.css("width", b),
        (this._scrollbarDist = this._scrollbarHolder.width() - b));
      if (!this.settings.scrollToLast) {
        if (this.carouselWidth >= this._totalItemsWidth) {
          this._wasBlocked = !0;
          this.settings.loopItems ||
            ((this._arrowRightBlocked = !0),
        ...
        this._wasBlocked &&
          (this._arrowLeftBlocked =
            this._arrowRightBlocked =
            this._wasBlocked =
              !1);
      }
      a ||
        ((a = this.endPos = this._getXPos()),
        0 < a
          ? (a = 0)
          : a < this.carouselWidth - this._maxXPos &&
            (a = this.carouselWidth - this._maxXPos),
        this.animateTo(a, 300, "easeInOutSine"));
    },
    animateTo: function (a, c, b, e, d, g, l) {
      ...
      null !== this.settings.onAnimStart &&
        this.settings.onAnimStart.call(this);
      this.autoplay &&
        this.autoplayTimer &&
        ((this.wasAutoplayRunning = !0), this._stopAutoplay());
      this._stopAnimation();
      var h = this,
      ...
      if (m) {
        ...
        this.settings.scrollbarAutoHide &&
          (this._scrollbarVisible || this._showScrollbar());
      }
      ...
      this._decelerationAnim = f(r).animate(t, {
        ...
        step: function () {
          m &&
            (v[n] =
              p + Math.round((-this.containerPos / w) * h._scrollbarDist) + q);
          u[n] = p + Math.round(this.containerPos) + q;
        },
        complete: function () {
          e
            ? (h._decelerationAnim = f(t).animate(x, {
                duration: g,
                easing: l,
                step: function () {
                  m &&
                    (v[n] =
                      p +
                      Math.round((-this.containerPos / w) * h._scrollbarDist) +
                      q);
                  u[n] = p + Math.round(this.containerPos) + q;
                },
                complete: function () {
                  m &&
                    (v[n] =
                      p +
                      Math.round((-x.containerPos / w) * h._scrollbarDist) +
                      q);
            ...
            : (m &&
                (v[n] =
                  p + Math.round((-t.containerPos / w) * h._scrollbarDist) + q),
              (u[n] = p + Math.round(t.containerPos) + q),
              k());
        },
      });
    },
    ...
    _updatePagingNav: function (a) {
      this._pagingEnabled &&
        ((this._currPageId = a = this._getPageIdFromItemId(a)),
        this.settings.pagingNavControls &&
          (this._pagingItems.removeClass("current"),
          this._pagingItems.eq(a).addClass("current")));
    },
    _getPageIdFromItemId: function (a) {
      for (var c = this._itemsPerMove, b = 0; b < this._numPages; b++)
        if (a >= b * c && a < b * c + c) return b;
    ...
    _getLastItemAtPos: function (a) {
      a = -a;
      for (var c = [], b = 0; b < this.numItems; b++)
        (currItem = this.items[b]),
          this.carouselRoot.width() + a >= currItem.posX + currItem.width &&
            c.push(currItem);
      return c.pop();
    },
    _getItemAtPos: function (a) {
      a = -a;
      for (var c, b = 0; b < this.numItems; b++)
        if (((c = this.items[b]), a >= c.posX && a < c.posX + c.width))
          return c;
      return -1;
    },
    _releaseAutoplay: function () {
      this.autoplay &&
        ...
        (this._isHovering || this._resumeAutoplay(),
    ...
    _stopAutoplay: function () {
      this.autoplayTimer &&
        (clearInterval(this.autoplayTimer), (this.autoplayTimer = ""));
    },
    _getXPos: function (a) {
    ...
    _onDragStart: function (a) {
      if (!this._isDragging) {
        ...
        if (this.hasTouch)
          if (
            ((this._lockYAxis = !1),
            (c = a.originalEvent.touches) && 0 < c.length)
          )
            c = c[0];
          else return !1;
        else (c = a), a.preventDefault();
        this._setGrabbingCursor();
        this._isDragging = !0;
        var b = this;
        this._useWebkitTransition &&
          b._dragContainer.css({
    ...
    _onDragMove: function (a) {
      ...
      if (this.hasTouch) {
        ...
        b = b[0];
        if (
          Math.abs(b.clientY - this._startMouseY) >
          Math.abs(b.clientX - this._startMouseX) + 3
        )
          return this.settings.lockAxis && (this._lockYAxis = !0), !1;
      } else b = a;
      a.preventDefault();
      ...
      if (0 != a) {
        ...
        0 <= e
          ? ((a /= 4), this._disableLeftArrow())
          : e <= this.carouselWidth - this._maxXPos
          ? (this._disableRightArrow(), (a /= 4))
          : this._enableArrows();
        this._moveDist += a;
        this.setXPos(e);
        -this._getXPos() >= this._maxXPos - this.carouselWidth &&
          null !== this.settings.onLastReached &&
          0 >= a &&
          !this.settings.lastReachedEventCalled &&
          (this.settings.onLastReached.call(this),
          (this.settings.lastReachedEventCalled = !0));
        this.settings.scrollbar &&
          this.setXPos(
            (-e / (this._maxXPos - this.carouselWidth)) * this._scrollbarDist,
            !0
          );
      }
      this._prevMouseX = b.clientX;
      350 < c - this._startTime &&
        ((this._startTime = c), (this._accelerationX = b.clientX));
      null !== this.settings.onDragStart &&
    ...
    _onDragRelease: function (a) {
      if (this._isDragging) {
        ...
        a = Math.max(
          40,
          (a.timeStamp || new Date().getTime()) - this._startTime
        );
        var d = 0.5;
        a = Math.abs(e) / a;
        if (this.settings.snapToItems) {
          ...
          this._pagingEnabled
            ? (e &&
                ((d = Math.max(d - this.carouselWidth - 1, 1 - b._maxXPos)),
                (g = this._getItemAtPos(d).index),
                void 0 === g && (g = this.numItems - 1)),
              (g = this._getPageIdFromItemId(g) * this._itemsPerMove))
            : (g += e ? this._itemsPerMove : -this._itemsPerMove + 1);
          g = e ? Math.min(g, this.numItems - 1) : Math.max(g, 0);
          d = this.items[g];
          this._updatePagingNav(g);
          d &&
            ((d = c(-d.posX)),
            (c = Math.abs(this.endPos - d)),
            (a = Math.max((1.08 * c) / a, 150)),
            (g = 180 > a),
            (c *= 0.08),
            e && (c *= -1),
            this.animateTo(
          ...
          (c = 0),
            2 >= a
              ? ((d = 3.5 * this._baseFriction), (c = 0))
              : 2 < a && 3 >= a
              ? ((d = 4 * this._baseFriction), (c = 200))
              : 3 < a &&
                ((c = 300),
                4 < a && ((a = 4), (c = 400), (d = 6 * this._baseFriction)),
                (d = 5 * this._baseFriction)),
            (e = ((a * a * 2) / (2 * d)) * (0 > e ? -1 : 1)),
            (d = (2 * a) / d + c),
            0 < this.endPos + e
              ? 0 < this.endPos
                ...
                : this.animateTo(
                    (this.carouselWidth / 10) * ((c + 200) / 1e3),
                    (1.1 * Math.abs(this.endPos)) / a,
                    "easeOutSine",
                    !0,
                    0,
                    400,
              ...
              : this.endPos + e < this.carouselWidth - this._maxXPos
              ? this.endPos < this.carouselWidth - this._maxXPos
                ...
                : this.animateTo(
                    ...
                    (1.1 *
                      Math.abs(
                        this.carouselWidth - this._maxXPos - this.endPos
                      )) /
                      a,
                    "easeOutSine",
                    !0,
              ...
              : this.animateTo(this.endPos + e, d, "easeOutCubic");
        null !== this.settings.onDragRelease &&
